...
if(strrpos($exe, "100% loss") > 0){
    ...
    <div class="card">     
           ...
           <div class="row">
                   <div class="col-md-12">
            <!--========================================================-->
            <small>VWS</small> เพชรบูรณ์ (ขาเข้า) <code><b>INTERNET OFFLINE</b></code>
                   </div>
...
#===================== End Diff Date Time ==========================
        ...
        <div class="card">     
           ...
           <div class="row" style="margin-top:-10px;">
                   <div class="col-md-12">
            <!--========================================================-->
                 <a style="color:#FFF" href="http://49.229.156.86:8080/vws"  target="_blank">  
                 <small>VWS</small> เพชรบูรณ์ (ขาเข้า)
                 </a>
                 <code><b>Anydesk ID : 360776330 </b></code>
            <!--========================================================-->
        ...
        <div class="card">     
               ...
               <div class="row">
                       <div class="col-md-12">
                <!--========================================================-->
                <small>VWS</small> เพชรบูรณ์ (ขาเข้า) <code><b>Database Disconnect</b></code>
                       </div>
